  ...
  var h = {
    ...
    updateSlides: function () {
      ...
      if (void 0 !== s) {
        ...
        for (
          var S, M = e.slidesPerColumn, P = E / M, z = Math.floor(h / e.slidesPerColumn), k = 0;
          k < h;
          k += 1
        ) {
          C = 0
      ...
      if (s.freeMode) {
        ...
        if (s.freeModeMomentum) {
          ...
          if (y < t.maxTranslate())
            ...
            y = -(y =
              Math.abs(d[S] - y) < Math.abs(d[S - 1] - y) || 'next' === t.swipeDirection
                ? d[S]
                : d[S - 1])
          }
          if (
    ...
    Q = {
      update: function (e) {
        ...
        for (var z = 0; z < u.length; z += 1)
          z >= x &&
            z <= T &&
            (void 0 === c || e ? M.push(z) : (z > c && M.push(z), z < p && S.push(z)))
        ...
        if (
          ...
          if (h)
            ...
            var S = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
              M =
                1.5 -
                (Math.sin((2 * S * Math.PI) / 360) / 2 + Math.cos((2 * S * Math.PI) / 360) / 2),
              P = d.shadowScale,
              z = d.shadowScale / M,
              k = d.shadowOffset
            e.transform(
...
!(function (t) {
  ...
  function a(e) {
    return this.each(function () {
      ...
      ;(o || 'destroy' != e) &&
        (o || a.data('bs.validator', (o = new r(this, i))), 'string' == typeof e && o[e]())
    })
  }
  ;(r.VERSION = '0.11.5'),
    ...
    (r.prototype.focusError = function () {
      if (this.options.focus) {
        ...
        0 !== e.length &&
          (t('html, body').animate({ scrollTop: e.offset().top - r.FOCUS_OFFSET }, 250), e.focus())
      }
    }),
...
jQuery(document).ready(function (s) {
  ...
  function d(s) {
    ...
    if (s.parents('.cd-headline').hasClass('type')) {
      ...
      s.parents('.cd-headline').hasClass('clip')
        ? s.parents('.cd-words-wrapper').animate({ width: '2px' }, 600, function () {
            h(s, i), l(i)
          })
  ...
  function l(s, i) {
    s.parents('.cd-headline').hasClass('type')
      ? (o(s.find('i').eq(0), s, !1, i), s.addClass('is-visible').removeClass('is-hidden'))
      : s.parents('.cd-headline').hasClass('clip') &&
        s.parents('.cd-words-wrapper').animate({ width: s.width() + 10 }, 600, function () {
          setTimeout(function () {
            d(s)
          }, 1500)
        })
        ...
        if (u !== C)
          return (
            ...
            (H = function () {
              ...
              if (m)
                return (
                  null == p && (('left' !== r && 'right' !== r) || a.insertAfter(h), h.remove()),
                  a.removeClass(t)
                )
            }),
            f.on('touchmove', l),
