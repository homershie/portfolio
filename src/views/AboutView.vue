...
const experiences = ref([
  {
    ...
    company: '問禮有限公司',
    description:
      '在2023年底，由於案源減少，我選擇尋找兼職工作以穩定收入。目前在問禮有限公司的工作，主要負責兒童英文學習教材出版的設計工作，包括繪製教材插圖和設計教材排版和包裝，並參與品牌的建置工作。以此穩定收入作為根基，我預計將朝前端工程師的方向努力。因此，我在兼職和接案的同時，開始進修JavaScript語言，以提升我的程式設計技能。',
  },
  {
    id: 2,
    period: '2019 - 現在',
    ...
    company: '接案中',
    description:
      '開始工作時，一直都有陸續接案，直到2019年與Gamin緊密合作，我開始以動態視覺設計全職接案。主要負責設計智慧手錶的錶面，並涵蓋平面設計、品牌營造、行銷視覺設計、動畫製作、影片剪輯和特效等多元業務。同時積極學習並累積大量作品，並在業餘時間持續進修動畫、3D、UI設計和網頁建置等專業知識，以提升自己的專業能力和服務品質。',
  },
  {
    id: 3,
    period: '2018 - 2019',
